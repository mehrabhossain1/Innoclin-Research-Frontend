...
const Footer: React.FC = () => {
    const footerLinks = {
        about: [
            { name: "Mission, Purpose & Values", href: "/about/mission-values" },
        ...
        services: [
            { name: "Early Phase Development", href: "/services/early-phase-development" },
            { name: "Phase II/III Studies", href: "/services/phase-ii-iii-studies" },
            { name: "Clinical Development Expertise", href: "/services/clinical-development-expertise" },
            { name: "Study Start-up", href: "/services/study-start-up" },
            { name: "Patient Pathway & Feasibility", href: "/services/patient-pathway-feasibility" },
            { name: "Regulatory Services", href: "/services/regulatory-services" },
            { name: "Pharmacovigilance", href: "/services/pharmacovigilance" },
            { name: "Medical Writing", href: "/services/medical-writing" },
            { name: "Biometrics & Biostatistics", href: "/services/biometrics-biostatistics" },
            { name: "Clinical Analytics", href: "/services/clinical-analytics" },
            { name: "Clinical Data Management", href: "/services/clinical-data-management" },
            { name: "Clinical Technology", href: "/services/clinical-technology" },
            { name: "RBQM", href: "/services/rbqm" },
            { name: "AI Principles", href: "/services/ai-principles" }
        ],
        expertise: [
            { name: "Neuroscience", href: "/expertise/neuroscience" },
            { name: "Oncology & Hematology", href: "/expertise/oncology-&-hematology" },
            { name: "Cardiovascular", href: "/expertise/cardiovascular" },
            { name: "Rare Disease", href: "/expertise/rare-disease" },
            { name: "Gastroenterology & Hepatology", href: "/expertise/gastroenterology-&-hepatology" },
            ...
            { name: "Infectious Diseases", href: "/expertise/infectious-diseases" },
            { name: "Respiratory Diseases", href: "/expertise/respiratory-diseases" },
            { name: "Reproductive Health", href: "/expertise/reproductive-health" },
                        ...
                        <div className="lg:col-span-2">
                            <div className="mb-8">
                                ...
                                <p className="text-slate-300 leading-relaxed mb-6">
                                    Accelerating clinical breakthroughs with precision, innovation, and patient-centric solutions. 
                                    Partner with us to bring life-changing treatments to patients faster.
                                </p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                                ...
                                <p className="text-sm text-slate-300 mb-4">
                                    Get the latest insights in clinical research and industry updates.
                                </p>
                ...
                <div className="border-t border-white/10 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-sm">
                            <Link href="/privacy-policy" className="text-slate-400 hover:text-[#0CB39A] transition-colors">
                                Privacy Policy
                            </Link>
                            <Link href="/transparency" className="text-slate-400 hover:text-[#0CB39A] transition-colors">
                                Transparency in Coverage
                            </Link>
                            <Link href="/cfius-disclosure" className="text-slate-400 hover:text-[#0CB39A] transition-colors">
                                CFIUS Disclosure
                            </Link>
                            <Link href="/terms" className="text-slate-400 hover:text-[#0CB39A] transition-colors">
                                Terms of Service
                            </Link>
                        </div>
                    </div>
