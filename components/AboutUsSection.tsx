    ...
    return (
        <section className="py-40 bg-white">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                {/* Left Side - Text */}
                <div>
                    <h2 className="text-3xl md:text-4xl font-normal mb-6 leading-snug">
                        Welcome to{" "}
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        With full of expertise, we are committed to advancing
                        the impact of clinical research — improving lives,
                        accelerating breakthroughs, and ensuring every project
                        reaches its full potential. Through transparent
                        communication, forward-thinking strategies,
                        adaptability, and innovative solutions, we partner with
                        our clients to achieve better outcomes and long-lasting
                        success.
                    </p>
                </div>
